      ...
      .then((data) => {
        if (!data.erro) {
          document.getElementById("logradouro").value =
            data.logradouro || document.getElementById("logradouro").value;
          document.getElementById("bairro").value =
            data.bairro || document.getElementById("bairro").value;
          document.getElementById("cidade").value =
            data.localidade || document.getElementById("cidade").value;
          document.getElementById("estado").value =
            data.uf || document.getElementById("estado").value;
        }
      })
